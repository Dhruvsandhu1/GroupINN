...
class Data_Config_Manager(Config_Manager):
    ...
    def add_parser_argument(self, parser: argparse.ArgumentParser):
        ...
        group.add_argument("--dataset_dir", default="Data", help="(default: %(default)s)")
        group.add_argument("--meta_filename", default="Data/demographics_data.csv", help="(default: %(default)s)")
